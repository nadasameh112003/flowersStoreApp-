                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(focusedBorder: OutlineInputBorder(borderSide: BorderSide(color: const Color.fromARGB(255, 76, 141, 95),)),
                          label: const Text('Full Name',style: TextStyle(color: Colors.black,),),
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(style: ButtonStyle(backgroundColor: MaterialStatePropertyAll(const Color.fromARGB(255, 76, 141, 95))),
                          ...
                          child: const Text('Sign up',style: TextStyle(fontSize: 17,color:Colors.white),),
                        ),
                      ),
                      const SizedBox(
                        height: 26.0,
                      ...
                      Row(
                        ...
                        children: [
                        Icon(Icons.facebook ,size: 37,color: const Color.fromARGB(255, 21, 94, 155),),
